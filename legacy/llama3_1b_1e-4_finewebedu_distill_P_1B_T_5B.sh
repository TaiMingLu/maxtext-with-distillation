...
export RUN_NAME="${MODEL_NAME}_distill_P_1B_T_5B"
...
export KD_TEACHER_PARAMETERS_PATH="/home/terry/gcs-bucket/model_ckpts/maxtext/teacher_params_only/checkpoint_2500/0/items"


echo "========================"
echo "running llama3_1b_1e-4_finewebedu_distill_P_1B_T_5B.sh"
echo "parameters:"
...
#         load_full_state_path=gs://taiming_us_central2_b/model_ckpts/maxtext/llama3.1-1b_seqlen_8192_bs_4_grad_accum_1_lr_2.e-4_min_lr_ratio_0.1_warmup_ratio_0.05_quadratic_warmup/checkpoints/2500/items \
#         checkpoint_dir=gs://taiming_us_central2_b/model_ckpts/maxtext/teacher_params_only/checkpoint_2500 \
