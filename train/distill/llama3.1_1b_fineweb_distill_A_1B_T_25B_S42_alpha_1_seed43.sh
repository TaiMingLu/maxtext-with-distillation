...
export KD_TEACHER_PARAMETERS_PATH="/home/terry/gcs-bucket/ckpts/pretrain_param_only/llama3.1-1b_finewebedu_pretrain_shuffled_lr_3e-4_seed_42/checkpoint_12500/0/items"
...
export RUN_NAME="${MODEL_NAME}_finewebedu_distill_pretrain_A_1B_T_25B_S42_alpha_1_seed43"
export RUN_ID="llama3-1b_finewebedu_distill_pretrain_A_1B_T_25B_S42_alpha_1_seed43"

# Distillation parameters

echo "========================"
echo "running llama3_1b_fineweb_distill_pretrain_A_1B_T_25B_S42_seed43.sh"
echo "parameters:"
