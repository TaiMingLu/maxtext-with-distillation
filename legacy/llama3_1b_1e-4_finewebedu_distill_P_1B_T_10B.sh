...
export RUN_NAME="${MODEL_NAME}_distill_P_1B_T_10B"
...
export KD_TEACHER_PARAMETERS_PATH="/home/terry/gcs-bucket/model_ckpts/maxtext/teacher_params_only/checkpoint_5000/0/items"


echo "========================"
echo "running llama3_1b_1e-4_finewebedu_distill_P_1B_T_10B.sh"
echo "parameters:"
