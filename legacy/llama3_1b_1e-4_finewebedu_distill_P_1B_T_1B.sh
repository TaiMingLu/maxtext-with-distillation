...
export RUN_NAME="${MODEL_NAME}_distill_P_1B_T_1B"
...
export KD_TEACHER_PARAMETERS_PATH="/home/terry/gcs-bucket/model_ckpts/maxtext/teacher_params_only/checkpoint_500/0/items"
